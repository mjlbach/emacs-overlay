...
This is my personal fork of the nix-community emacs-overlay, which includes bundling of nixpkgs and the use of github actions for all builds.
...
For this fork, also add my binary cache `cachix use mjlbach`
* Community
